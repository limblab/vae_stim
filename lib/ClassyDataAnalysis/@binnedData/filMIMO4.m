...
%this is a method of the binnedData class, and should live
%in the @binnedData folder with the other class methods
%
% Solves for the nonparametric filters of a MIMO linear
% system using a correlation function based approach.
% this method is based on the old filMIMO4 function found
% in the limblab_analysis git repo, (and previously the 
% S1_analysis svn repo). This differs from other versions
% in those repos like filMIMO3 because it detrends the data
% before fitting and then manually adds the trend data back
% to the weights matrix at the end of the method
%
